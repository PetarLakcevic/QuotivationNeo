...
import { addQuote, getAuthor, getAuthors, getCategories, getCategory, getQuotes } from '../../../axios/axios.js';
import DialogStyled from '../../../components/DialogStyled.jsx';

const AddQuoteCat = ({  category, setCategory, setAddQuoteDialog }) => {
  ...
  const handleAdd = () => {
    ...
    addQuote(textRef.current.value, selectedAuthor, [{id: category.id}])
      .then(response => {
