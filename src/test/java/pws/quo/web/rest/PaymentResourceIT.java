...
class PaymentResourceIT {
    ...
    public static Payment createEntity(EntityManager em) {
        Payment payment = new Payment().paymentDate(DEFAULT_PAYMENT_DATE);
        return payment;
    }
    ...
    public static Payment createUpdatedEntity(EntityManager em) {
        Payment payment = new Payment().paymentDate(UPDATED_PAYMENT_DATE);
        return payment;
    }
    ...
    @Test
    @Transactional
    void getAllPaymentsByUserAdditionalFieldsIsEqualToSomething() throws Exception {
        ...
        // Get all the paymentList where userAdditionalFields equals to userAdditionalFieldsId
        defaultPaymentShouldBeFound("userAdditionalFieldsId.equals=" + userAdditionalFieldsId);

        // Get all the paymentList where userAdditionalFields equals to (userAdditionalFieldsId + 1)
        defaultPaymentShouldNotBeFound("userAdditionalFieldsId.equals=" + (userAdditionalFieldsId + 1));
    }
